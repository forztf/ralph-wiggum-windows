...
Debug logs are written to `.claude/ralph-debug.log` in your project directory. Check this file if the loop behaves unexpectedly.
...
- This Windows fork: https://github.com/Arthur742Ramos/ralph-wiggum-windows
